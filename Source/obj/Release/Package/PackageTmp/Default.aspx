...
<body>
    <form id="id01" runat="server">
      ...
      <asp:TextBox ID="TextBox1" runat="server" CssClass="textbox" placeholder="Enter Email" name="email" TextMode="Email"></asp:TextBox>

      <label for="psw"><b>Password</b></label>
      <asp:TextBox ID="TextBox2" runat="server" CssClass="textbox" placeholder="Enter Password" name="psw" TextMode="Password"></asp:TextBox>
      ...
      <div class="clearfix">
        <asp:Button ID="Button1" runat="server" class="cancelbtn" Text="Cancel" BorderColor="White" BorderStyle="Groove" ForeColor="White" Height="50px" />
